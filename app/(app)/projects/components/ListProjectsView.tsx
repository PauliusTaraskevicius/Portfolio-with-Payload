        ...
        <div className="relative mt-1 -mb-4 w-full gap-4 p-2 md:-mb-28 lg:col-span-12">
          <div className="relative flex w-full flex-col items-start justify-between gap-4 md:flex-row md:items-end">
            <div className="flex max-w-2xl justify-start overflow-hidden text-center lg:text-start">
              <h2 className="font-bebas text-3xl text-white sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl">
                Here is a selection of my most recent works
              </h2>
            </div>

            <span className="font-bebas hidden text-start text-xl text-white/20 uppercase md:text-end md:text-2xl lg:flex">
              ...
              return (
                ...
                >
                  <Link
                    ...
                    className="group relative block cursor-pointer pb-4"
                  >
                    <span className="font-bebas text-[34px] leading-[0.9] font-semibold text-white uppercase transition hover:text-white/20 md:text-[78px]">
                      {item.title}
                    </span>
                  </Link>
                </div>
